                ...
                <ul id="comments-list" class="comments-list">
                  ...
                  <li>
                    <div class="comment-main-level">
                      <!-- Avatar -->
                      <div class="comment-avatar"><img src="https://e7.pngegg.com/pngimages/108/97/png-clipart-anonymous-desktop-anonymity-advertising-anonymous-emblem-logo.png" alt=""></div>
                      <!-- Contenedor del Comentario -->
                      <div class="comment-box">
                        <div class="comment-head">
                          <h6 class="comment-name"><a href="#">{{$c->user->name}}</a></h6>
                          <span><i class="fa fa-clock-o" aria-hidden="true"> January 15 , 2014 at 10:00 pm</i></span> <i class="fa fa-reply"></i> <i class="fa fa-heart"></i> 
                        </div>
