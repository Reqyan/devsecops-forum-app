                                        ...
                                        <div class="col-md-9">
                                            <div class="right-description893">
                                                <div id="que-hedder2983">
                                                    <h3><a href="{{ route('detail-posts', $data_post->id) }}"
                                                            target="_blank">{{ $data_post->title }}</a></h3>
                                                </div>
            ...
            <div class="question-type2033">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="right-description893">
                    <div id="que-hedder2983">
                      <h3><a href="post-deatils.html" target="_blank">How Did You Hear About This Position?</a></h3>
                    </div>
                    <div class="ques-details10018">
            ...
            <div class="question-type2033">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="right-description893">
                    <div id="que-hedder2983">
                      <h3><a href="post-deatils.html" target="_blank">Why Do You Want to Work at This Company?</a></h3>
                    </div>
                    <div class="ques-details10018">
            ...
            <div class="question-type2033">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="right-description893">
                    <div id="que-hedder2983">
                      <h3><a href="post-deatils.html" target="_blank">Why Do You Want This Job?</a></h3>
                    </div>
                    <div class="ques-details10018">
                      <p>Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.</p>
                    </div>
            ...
            <div class="question-type2033">
              <div class="row">
                ...
                <div class="col-md-9">
                  <div class="right-description893">
                    <div id="que-hedder2983">
                      <h3><a href="post-deatils.html" target="_blank">Why Should We Hire You?</a></h3>
                    </div>
                    <div class="ques-details10018">
                      <p>Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.Duis dapibus aliquam mi, eget euismod sem scelerisque ut. Vivamus at elit quis urna adipiscing iaculis.</p>
                    </div>
      ...
      <aside class="col-md-3 sidebar97239">
        ...
        <div class="login-part2389">
          ...
          <div class="rememberme">
            <label>
            <input type="checkbox" checked="checked"> Remember Me</label> <a href="#" class="resbutton3892">Register</a> 
          </div>
        </div>
        <!--              highest part-->
